...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.dobbl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
app.get('/', (req, res) => {
    res.send('starplus server is running')
})
